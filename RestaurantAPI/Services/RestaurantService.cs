...
namespace RestaurantAPI.Services
{
    public class RestaurantService : IRestaurantService
    {
        ...
        public PagedResult<RestaurantDto> GetAll(RestaurantQuery query)
        {
            ...
            var resteurantDtos = _mapper.Map<List<RestaurantDto>>(restaurants);

            var result = new PagedResult<RestaurantDto>(resteurantDtos, totalItemsCount, query.PageSize, query.PageNumber);
